...
const experience: experience[] = [
  {
    ...
    logo: logo1,
    description: [
      "Specialized in crafting validation rules in Node.js, ensuring the integrity of incoming requests through intricate business logic. Implemented logic for client account relationships, client-client relationships, and various account types across different client and account categories.",
...

  {
    ...
    logo: bits,
    description: [
      "Played a crucial role in the development of responsive and intuitive user interfaces using ReactJS and Redux for two distinct telecom projects.",
    ...
    techs:
      "Reactjs, Redux, Typescript, Bootstrap, Nodejs, Express, MongoDB, Vults,Digital Ocean",
        ...
        >
          ...
          >
            {experience.map((items, index) => (
              <Tab key={index} label={items.title} {...a11yProps(index)} />
            ))}
          </Tabs>
        </Box>
        <Box>
